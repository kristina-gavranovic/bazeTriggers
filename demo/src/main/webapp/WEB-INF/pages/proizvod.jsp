...
$('#saveNazivJM').on('click', function(){
	var myElement = document.getElementById("nazivjm");
	
	  var editedContent   = theContent.html();
	  localStorage.newNaziv = editedContent;
	  myElement.attribute=editedContent;
	  nazivjm.attribute=editedContent;
	});
